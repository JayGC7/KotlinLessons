...
fun main(){
    ...
    val analysis = (sun_today == sun_condition) && (open_tent_today == open_tent_condition) && (humidity_today == humidity_condition) && (season_today != bad_season) && (open_tent_today == open_tent_condition)
